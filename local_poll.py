...
# 获取li标签对应设备号
    ...
    for i in range(1, 382):
        time = tree.xpath(f"/html/body/div[2]/div[1]/div[1]/ul/li[{i}]/span/text()")
        device_li_dict[f'{time}'] = i
    ...
    while count < 9:
        ...
        for key, value in in_device_li_dict.items():
            ...
            tree = etree.HTML(page_source)
            time = tree.xpath('//*[@id="app"]/section/section/main/div/div/div[1]/div[1]/div[2]/div/div[1]/div/div[1]/div[1]/div/span/text()')
            ...
            # text.insert(tk.END, "\n" + str(num[1]))
            #
            # text.tag_configure("green_circle", foreground="green")
            # text.insert(tk.END, "\u25CF ", "    " + "green_circle")  # 插入一个绿色圆圈
        count += 1
