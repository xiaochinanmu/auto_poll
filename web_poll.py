...
def show_webpage_content():
    ...
    while True:
        ...
        for key, value in in_device_li_dict.items():
            ...
            tree = etree.HTML(page_source)
            time0 = tree.xpath('//*[@id="app"]/section/section/main/div/div/div[1]/div[1]/div[2]/div/div[1]/div/div[1]/div[1]/div/span/text()')
            ...
            # tu.quit()
            text.update()
            if gps==['status:1'] and xiangji==['status:2'] and gravity==['status:1'] :
                print("111")
